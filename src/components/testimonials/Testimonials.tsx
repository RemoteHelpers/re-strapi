        ...
        <SwiperSlide>
          <div className="Testimonials__slide">
            ...
            <p className="Testimonials__paragraph">
              Приятная атмосфера, дружелюбный и отзывчивый коллектив,
              к которому ты быстро привыкаешь и уже через неделю чувствуешь себя как дома.
              Понимающее начальство,с которым можно обсудить любую проблему.
              Тебя выслушают и всегда подскажут как выйти из конкретной ситуации.
              Все это придает уверенности и желания двигаться вперед.
            </p>
          </div>
        </SwiperSlide>
        <SwiperSlide>
